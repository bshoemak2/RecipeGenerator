// C:\Users\bshoe\OneDrive\Desktop\game_theory\cooking\RecipeGenerator\app\(tabs)\data.ts
...
export const cookingStyles = ['asian', 'cajun', 'french', 'indian', 'latin', 'mediterranean', 'southern'];
export const foodCategories = ['dinner', 'dessert', 'breakfast', 'lunch'];
